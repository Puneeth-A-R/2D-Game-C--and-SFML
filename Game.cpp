...
void Game::initFonts()
{
	try
	{
		if (!this->font.loadFromFile("Fonts/timesbd.ttf"))
		{
			throw 1;
		}
	}
	...
	catch (int error)
	{
		...
		this->font.loadFromFile("Fonts/timesbd.ttf");
	}
...
void Game::updateEnemies()
{
	...
	*/
	...
	// Checking to see if enemy has gone below the window height
...
void Game::update()
{
	...
	//Log Real-time mouse positions (X and Y co-ordinates)
